...
def print_menu():
    ...
    # ----------------------------------------------------
    # New Feature: Server-Side Usage Reset (Option 18)
    # ----------------------------------------------------
    # Ensure you have 'menu.reset_server_usage' in your language file
    print(f"{Fore.YELLOW}  {EMOJI['STAR']}  18. {translator.get('menu.reset_server_usage', default='Reset Account Usage (Token/API)')}{Style.RESET_ALL}")
        ...
        try:
            ...
            match choice:
                ...
                case "12":
                    ...
                    check_user_authorized.run(translator)
                    print_menu()
                case "13":
                ...
                case "17":
                    ...
                    print_menu()
                case "18":
                    # New Case: Server-side usage reset
                    import cursor_acc_info
                    cursor_acc_info.UsageManager.reset_server_usage(translator)
                    print_menu()
                case _:
                    print(f"{Fore.RED}{EMOJI['ERROR']} {translator.get('menu.invalid_choice')}{Style.RESET_ALL}")
                    print_menu()
