...
function Get-LatestVersion {
    try {
        $latestRelease = Invoke-RestMethod -Uri "https://api.github.com/repos/MR-JLTC/CSR_AI-Bypass/releases/latest"
        return @{
...
Write-Host "Created by Mr.Loyd`n" -ForegroundColor $Theme.Info
